...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <a class="btn btn-primary btn-lg" href="index.php?c=course&m=add">Add Course</a>
        <div class="row mt-3">
        ...
        <table class="table table-bordered table-striped my-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?c=course&m=edit&id=<?= $item['id']; ?>"
                            class="btn btn-primary btn-sm">Edit</a>
                    </td>
                    <td>
                        <a href="index.php?c=course&m=delete&id=<?= $item['id']; ?>" class="btn btn-danger
                             btn-sm">Delete</a>
                    </td>
                </tr>
                <?php endforeach;?>
